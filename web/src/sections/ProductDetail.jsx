    ...
    <div className="max-w-6xl w-full px-6">
      ...
      <div className="flex flex-col md:flex-row gap-16 mt-4">
        <div className="flex gap-3">
          <div className="flex flex-col gap-3">
            {(product.images || []).map((image, index) => (
              <button
                ...
                className="border border-gray-500/30 rounded overflow-hidden cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500"
              >
                <div className="w-20 h-20 md:w-24 md:h-24 flex items-center justify-center bg-white overflow-hidden">
          ...
          <div className="border border-gray-500/30 rounded overflow-hidden bg-white">
            <div className="w-[18rem] h-[18rem] sm:w-[22rem] sm:h-[22rem] md:w-[26rem] md:h-[26rem] lg:w-[28rem] lg:h-[28rem] flex items-center justify-center">
              <img
                src={thumbnail}
        ...
        <div className="text-sm w-full md:w-1/2">
          ...
          <div className="flex items-center mt-10 gap-4 text-base">
            <button className="w-full py-3.5 cursor-pointer font-medium bg-gray-100 text-gray-800/80 hover:bg-gray-200 transition rounded-md">
              Add to Cart
            </button>
            <button className="w-full py-3.5 cursor-pointer font-medium bg-purple-600 hover:bg-purple-700 transition text-white rounded-md">
              Buy now
            </button>
          </div>
        </div>
