  ...
  return (
    <>
      ...
      >
        ...
        {/* Mobile menu */}
        <div
          className={`fixed inset-0 flex flex-col items-center justify-center gap-6 text-lg font-bold bg-white/60 dark:bg-black/40 backdrop-blur-md md:hidden transition duration-300 ${
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <Link
            to="/cart"
            className="relative p-2 hover:bg-slate-100 dark:hover:bg-purple-950 rounded-md transition"
          >
            <img
            ...
            />
            {/* Badge số lượng */}
            <span className="absolute -top-1.5 -right-1.5 bg-purple-600 text-white text-xs font-medium px-1.5 py-0.5 rounded-full">
              3
            </span>
          </Link>
