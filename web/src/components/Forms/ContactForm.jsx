...
export default function ContactForm() {
  ...
  return (
    <form className="flex flex-col items-center text-sm text-slate-800 mt-50 mb-10">
      ...
      <div className="max-w-96 w-full px-4">
        ...
        <div className="flex items-center justify-between gap-2 mt-5">
          <button
            type="button"
            onClick={() => navigate("/")}
            className="flex-[1] flex items-center justify-center gap-1 bg-white text-purple-600 font-medium py-2.5 rounded-full border border-purple-500 transition hover:bg-purple-50"
          >
            Go Home
          </button>
          ...
          <button
            type="submit"
            className="flex-[3] flex items-center justify-center gap-1 bg-purple-500 hover:bg-purple-600 text-white py-2.5 rounded-full transition"
          >
            Submit Form
            <svg
              className="mt-0.5"
