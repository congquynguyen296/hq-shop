  ...
  return (
    <footer className="relative px-6 md:px-16 lg:px-24 xl:px-32 mt-40 w-full dark:text-slate-50">
      <img
        ...
        src={"/assets/landing-text-dark.svg"}
        alt="landing"
        width={930}
        height={340}
      />
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-200 dark:border-slate-700 pb-6">
        <div className="md:max-w-114">
          ...
          />
          <p className="mt-6">
            At Landing Shop, we bring you a wide range of genuine technology
            products that combine quality, innovation, and reliability. From the
            latest gadgets to essential accessories, secure shopping
            experience.
          </p>
        </div>
        <div className="flex-1 flex items-start md:justify-end gap-20">
          ...
          <div>
            ...
            <div className="space-y-2">
              <p>+84-976-870127</p>
              <p>22110403@student.hcmute.edu.vn</p>
            </div>
          </div>
        </div>
      </div>
      <p className="pt-4 text-center pb-5">Copyright 2025 © 22110403. HCMUTE</p>
    </footer>
  );
}
